...
namespace HostMe.Sdk {
    ...
    export class MobileWaitingManagementApi {
         ...
         */
        public confirmWithApp (confirmationCode: number, conf: PhoneConfirmation, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param value 
         */
        public getInLine (value: PutInLine, extraHttpRequestParams?: any ) : ng.IHttpPromise<WaitingItem> {
         ...
         */
        public sendMessageToWaiting (waitingItemId: number, createMessage: CreateMessage, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
